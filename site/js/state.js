...
export function createDefaultState() {
  ...
  return {
    ...
    betFirstScorerPerMatch: CONFIG.DEFAULT_BET_FIRST_SCORER,
...
function normalizeState(raw) {
  ...
  const matches = fixtures.map(f => {
    ...
    return {
      ...
      predictions,
      firstScorerResult: existing?.firstScorerResult || "",
  ...
  return {
    ...
    betFirstScorerPerMatch: Number(raw.betFirstScorerPerMatch) > 0
      ? Math.floor(Number(raw.betFirstScorerPerMatch))
      : CONFIG.DEFAULT_BET_FIRST_SCORER,
